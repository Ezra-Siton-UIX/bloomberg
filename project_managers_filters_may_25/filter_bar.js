...
const data_filter_btns = document.querySelectorAll("[data_filter_btn]");
...
data_filter_btns.forEach((data_filter_btn) => {
  data_filter_btn.addEventListener("keydown", function (e) {
    if (event.key === "Enter") {
